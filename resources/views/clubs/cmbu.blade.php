...
<meta property="og:image" content="https://princeofwales.edu.lk/resources/cmbu/images/cmbu-header.webp" />
...
<meta property="twitter:image" content="https://princeofwales.edu.lk/resources/cmbu/images/cmbu-header.webp" />
   
<title>Cambrians' Media & Broadcasting Unit</title>

   <link rel="icon" type="image/png" href="/resources/cmbu/images/logo red.webp">

    <link rel="stylesheet" href="/resources/cmbu/css/styles.css">
...
<body>
    ...
    <!--loader-end-->
        ...
        <div id="navigation-content">
            <div class="logo">
                <img src="/resources/cmbu/images/logo red.webp" alt="logo">
            </div>
        ...
        <div id="header">
            ...
            <div class="social-media-links">
               <a href="https://www.instagram.com/cmbulive/" target="_blank"><img src="/resources/cmbu/images/instagram logo.webp" class="social-media" alt="instagram-logo"></a>
                <a href="https://www.facebook.com/cambrians.media" target="_blank"><img src="/resources/cmbu/images/facebook logo.webp" class="social-media" alt="facebook-logo"></a>
                <a href="https://www.youtube.com/cmbulive" target="_blank"><img src="/resources/cmbu/images/youtube logo.webp" class="social-media" alt="linkedin-logo"></a>
            ...
            <span class="slash">|</span>
                    ...
                    <div class="contact">
                <a href="Mailto:pwcmbu@gmail.com"><img src="/resources/cmbu/images/mail.webp" alt="email-pic" class="contactpic" target="_blank"></a>
                <a href="Tel:+94112645628"><img src="/resources/cmbu/images/call.webp" alt="phone-pic" class="contactpic" target="_blank"></a>
                    </div>    
            </div>
            </div>
            <!--header image-->
            <div class="header-image">
            <img src="/resources/cmbu/images/home bg.jpg" alt="logo">
            </div>
            <!--header image end-->
        </div>
           <!--Header End-->
        ...
        <div id="about">
            ...
            <!--about picture-->
            <div class="about-img">
                <img src="/resources/cmbu/images/about.webp" alt="about">
            </div>
            </div>
            ...
            <!--services content-->
                    <div class="services-content">
                           <div class="service-one service wow">
                               ...
                               <img src="/resources/cmbu/images/announcing.webp" alt="announcing">
                               </div>
                           ...
                           <div class="service-one service wow">
                               <div class="service-img">
                               <img src="/resources/cmbu/images/technical.webp" alt="technical">
                               </div>
                               <div class="service-description">
                                <h2>Technical</h2>
                           ...
                           <div class="service-one service wow">
                               <div class="service-img">
                               <img src="/resources/cmbu/images/graphics.webp" alt="graphics">
                               </div>
                               <div class="service-description">
                           ...
                           <div class="service-one service wow">
                               <div class="service-img">
                               <img src="/resources/cmbu/images/dubbing.webp" alt="dubbing">
                               </div>
                               <div class="service-description">
                                <h2>Dubbing</h2>
                           ...
                           <div class="service-one service wow">
                               <div class="service-img">
                               <img src="/resources/cmbu/images/news.webp" alt="news">
                               </div>
                               <div class="service-description">
                                <h2>News</h2>
                           ...
                           <div class="service-two service wow">
                               <div class="service-img">
                               <img src="/resources/cmbu/images/photography.webp" alt="photography">
                               </div>
                               <div class="service-description">
                                <h2>Photography</h2>
                           ...
                           <div class="service-three service wow">
                            <div class="service-img">
                               <img src="/resources/cmbu/images/videography.webp" alt="videography">
                            </div>
                            <div class="service-description">
                                <h2>Videography</h2>
             ...
             <div id="portfolio-content">
                 <div class="portfolio portfolio-second">
                    <div class="portfolio-image">
                        <img src="/resources/cmbu/images/21comp.webp" alt="Sadbhashana">
                    </div>
                ...
                <div class="portfolio portfolio-third">
                    <div class="portfolio-image">
                        <img src="/resources/cmbu/images/20comp.webp" alt="Sadbhashana">
                    </div>
                    <div class="portfolio-text">
                ...
                <div class="portfolio portfolio-fourth">
                    <div class=" portfolio-image">
                        <img src="/resources/cmbu/images/19day-cmbu.webp" alt="Sadbhashana">
                    </div>
                    <div class="portfolio-text">
                ...
                <div class="portfolio portfolio-fourth">
                    <div class=" portfolio-image">
                        <img src="/resources/cmbu/images/comp-18-cmbu.webp" alt="Sadbhashana">
                    </div>
                    <div class="portfolio-text">
                ...
                <div class="portfolio portfolio-fourth">
                    <div class=" portfolio-image">
                        <img src="/resources/cmbu/images/day17-cmbu.webp" alt="Sadbhashana">
                    </div>
                    <div class="portfolio-text">
                ...
                <div class="portfolio portfolio-fourth">
                    <div class=" portfolio-image">
                        <img src="/resources/cmbu/images/16comp.webp" alt="Sadbhashana">
                    </div>
                    <div class="portfolio-text">
                ...
                <div class="portfolio portfolio-fourth">
                    <div class=" portfolio-image">
                        <img src="/resources/cmbu/images/15day.webp" alt="Sadbhashana">
                    </div>
                    <div class="portfolio-text">
            ...
            <!--Contact information-->
             <div class="contact-info">
                ...
                <div class="contect-info-content-line">
                  <img src="/resources/cmbu/images/icon-location.webp" class="icon" alt="location-icon">
              ...
              <div class="contect-info-content-line">
                  <img src="/resources/cmbu/images/icon-phone.webp" class="icon" alt="phone-icon">
                  <div class="contact-info-icon-text">
                      <h6>Call</h6>
                      <p>0112 645 628</p>
                </div>
              ...
              <div class="contect-info-content-line">
                  <img src="/resources/cmbu/images/icon-email.webp" class="icon" alt="email-icon">
                  <div class="contact-info-icon-text">
                      <h6>Email</h6>
    ...
    <!--all the divisions-->
    <script src="/resources/cmbu/js/jquery.min.js"></script>
    <script src="/resources/cmbu/js/index.js"></script>
