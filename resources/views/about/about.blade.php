...
?>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            $rowCount = 0;
            ?>
            @foreach($schoolAdministration as $administration)
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item bg-light">
                    <div class="overflow-hidden">
                        <img class="img-fluid"
                            src="/content/img/img-about/administration/{{ $administration->img }}"
                            alt="{{ $administration->name }}" style="width: auto;">
                    </div>
            ...
            <center>
                <a class="btn btn-primary py-3 px-5 mt-2 wow zoomIn" href="/about/school-administration"
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <?php
$prefectTopboard = DB::table('about_prefect_topboard')->get();
$limit = 4;
$rowCount = 0;
?>
@if($prefectTopboard->isNotEmpty())
    @foreach($prefectTopboard as $prefect)
        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="team-item bg-light">
                <div class="overflow-hidden">
                    <img class="img-fluid" src="/content/img/img-about/prefects/{{ $prefect->img }}"
                        alt="{{ $prefect->name }}" style="width: auto;">
                </div>
                <div class="text-center p-4">
                    <h5 class="mb-0">{{ $prefect->name }}</h5>
                    <small>{{ $prefect->post }}</small>
                </div>
            </div>
        </div>
        <?php
