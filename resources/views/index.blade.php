...
<div class="colorlib-blog colorlib-light-grey py-2">
    <div class="container">
            ...
            <div class="col-md-4 animate-box wow fadeInUp" data-wow-delay="0.1s">
                <article class="article-entry">
                    <a href="blog/{{ $row->slug }}" class="blog-img">
                        <img src="content/img/img-blog/{{ $row->photo }}" alt="{{ $row->photo }}" width="600"
                            height="400" loading="lazy"><br><br>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <p style="font-size: 16px;" class="h1 section-title bg-white text-center text-primary px-3">UPCOMING
                & PAST
            </p>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="course-item bg-light">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" style="width: auto;" src="content/img/img-events/{{ $row->img }}"
                            alt="{{ $row->title }}" loading="lazy">
                    </div>
                    <div class="text-center p-4 pb-0">
                        <h4 class="mb-4">{{ $row->title }}</h4>
                    </div>
                    <div class="w-100 d-flex justify-content-center bottom-0 start-0 mb-4">
                        <a href="events/{{ $row->slug }}" class="flex-shrink-0 btn btn-sm btn-primary px-3"
                            style="border-radius: 30px 30 30 30px;">View Event</a>
                    </div>
                    <div class="d-flex border-top">
                        <small class="flex-fill text-center border-end py-2"><i
                                class="fa fa-calendar text-primary me-2"></i>{{ $row->date }}</small>
                        <small class="flex-fill text-center py-2"><i
                                class="fa fa-map-marker text-primary me-2"></i>{{ $row->location }}</small>
                    </div>
                </div>
            </div>
...
@php
$principalMsg = DB::table('principal_msg')->get();
@endphp

@foreach ($principalMsg as $row)
<!-- msg Start -->
<div class="container-xxl py-5">
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid position-absolute w-100 h-100" src="content/img/img-home/{{ $row->img }}"
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <p class="mb-4">{!! substr($row->msg, 0, 500) !!}
    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <p class="mb-4">The Prince of Wales'–St. Sebastian's Cricket Encounter (The Battle of the Golds)
                    is
                    an annual cricket match played between Prince of Wales' College and St. Sebastian's College
                    since 1933. <br><br>It is known as The Battle of the Golds due to the colours of the two
                    school's
                    flags i.e. Purple, Gold and Maroon of Prince of Wales' College and Green, White & Gold of
                    St.
...
<div class="container-fluid bg-primary py-5 mb-5 explore-history-page-header">
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-10 text-center">
                <p class="h1 display-3 text-white animated slideInDown"><?php echo $age ?> Years and Counting
                </p>
                <p style="font-size: 20px;" class="h2 text-white animated slideInDown"><br> Explore college
                    history and
