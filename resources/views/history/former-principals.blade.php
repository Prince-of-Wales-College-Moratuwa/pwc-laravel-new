...
<body>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <?php
            $pastPrincipals = DB::table('about_past_principals')->orderByDesc('id')->get();
            ?>
            @if($pastPrincipals->isNotEmpty())
                @foreach($pastPrincipals as $principal)
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid"
                                src="/content/img/img-history/former-principals/{{ $principal->img }}"
